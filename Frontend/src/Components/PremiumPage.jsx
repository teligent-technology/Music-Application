  ...
  const handleUpgradeClick = async () => {
    ...
    try {
      const res = await axios.post(
        "https://music-application-teligent-technology-9ya2.onrender.com/api/payment/create-order"
      );
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            await axios.post("https://music-application-teligent-technology-9ya2.onrender.com/api/payment/person/upgrade", {
